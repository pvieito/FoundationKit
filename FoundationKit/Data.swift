...
fileprivate let hexadecimalConversionArray: [[UInt8]] = [[48, 48], [48, 49], [48, 50], [48, 51], [48, 52], [48, 53],
...
extension Data {
    ...
    /// Efficient string hexadecimal representation.
    public var hexString: String {
        
        return "0x" + String(data: self.hexData, encoding: .ascii)!.uppercased()
    }
    
    /// Efficient data hexadecimal representation.
